...
class MainWindow(QWidget):
    ...
    def __init__(self, *,
        ...
        # my-browser fork: persistent bookmark + plugin chrome bar (row 1)
    ...
    def _add_widgets(self):
        ...
        self._vbox.removeWidget(self._pinbar)
        widgets: list[QWidget] = [self.tabbed_browser.widget]

        # my-browser fork: three stacked chrome rows at the top of the content
        # column — row 1 bookmarks/plugins, row 2 pinned shortcuts, row 3 the
        # tab widget's own tab bar (tabs.position = top).
        widgets.insert(0, self._pinbar)
