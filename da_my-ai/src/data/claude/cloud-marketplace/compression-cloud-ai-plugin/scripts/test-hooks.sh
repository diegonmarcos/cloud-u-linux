...
echo "## inject: this plugin wires no SessionStart rule — engine falls back, hooks.json never calls it ##"
echo "## inject: PreToolUse + UserPromptSubmit carry the one-line pointer (the plugin's actual job) ##"
